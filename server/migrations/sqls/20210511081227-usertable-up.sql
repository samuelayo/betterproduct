...
INSERT INTO users (uuid, first_name, last_name, user_group, username, user_password, created_at, updated_at) VALUES ('0b6a3eaf-58de-43b1-9a5a-c0be8745e167', 'Mengano', 'User', 'user', 'user', crypt('one.admin.two.three', gen_salt('bf', 8)), NOW(), NOW());
